    ...
    return (
        <Box sx={{ display: 'flex', alignItems: 'center' }}>
            ...
            <FormControl sx={{ width: '160px' }}> 
                <InputLabel sx={{ color: '#a4a7a7', fontSize: '15px', transform: selectedOption ? 'translate(0, -15px) scale(0.75)' : 'translate(0, 0)',  '&.Mui-focused': { color: '#FFFFFF' } }}>{labelChoice}</InputLabel>
                <Select
