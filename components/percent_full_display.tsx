    ...
    return(
        <div>
            <Box sx={{width: 40, height: 70, border: '1.5px solid #e0e0e0', borderRadius: '25px',overflow: 'hidden',position: 'relative',backgroundColor: 'fcfbfc'}}>
                <Typography  sx={{ fontSize: '0.95rem', textAlign: 'center', position: 'absolute', width: '100%', top: '50%', transform: 'translateY(-50%)', zIndex: 1, fontWeight: 'bold'}}>{percent_full}%</Typography>
